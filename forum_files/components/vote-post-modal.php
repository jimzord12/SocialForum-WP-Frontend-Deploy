      ...
      <div class="relative w-full max-w-2xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 items-center">
              ...
              <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                  ...
                  <button id="modal-btn-vote-post-connect" data-modal-hide="post-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Connect Now</button>
              </div>
          </div>
      </div>
  </div>
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const modal_btn_collect = document.querySelector('#modal-btn-vote-post-collect');
    const modal_btn_connect = document.querySelector('#modal-btn-vote-post-connect');
    const like_dislike_vote = document.querySelectorAll('.pld-like-dislike-trigger');
    ...
    vote.setAttribute('data-modal-target', "post-modal");
    vote.setAttribute('data-modal-toggle','post-modal');
